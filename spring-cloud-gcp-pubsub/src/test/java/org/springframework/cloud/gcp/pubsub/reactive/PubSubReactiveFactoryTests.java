...
public class PubSubReactiveFactoryTests {
	...
	@Test
	public void testIllegalArgumentExceptionWithMaxMessagesLessThanZero() {
		assertThatThrownBy(() -> factory.poll("sub1", 10, -1))
				.isInstanceOf(IllegalArgumentException.class)
				.hasMessage("maxMessages cannot be less than 0");
	}
	...
	public void testUnlimitedDemandWithMaxMessages() throws InterruptedException {
		...
		StepVerifier.withVirtualTime(() -> factory.poll("sub1", 10, 2).map(this::messageToString))
				.expectSubscription()
				.expectNext("msg1", "msg2")
