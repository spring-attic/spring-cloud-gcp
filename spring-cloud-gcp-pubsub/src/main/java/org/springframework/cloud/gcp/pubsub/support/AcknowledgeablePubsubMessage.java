...
/**
 * An extension of {@link BasicAcknowledgeablePubsubMessage} that exposes ack ID and
 * subscription name of the message. It also allows modification of the ack deadline and
 * acknowledgement of multiple messages at once using
...
public interface AcknowledgeablePubsubMessage extends BasicAcknowledgeablePubsubMessage {
	...
	/**
	 * Modify the ack deadline of the message. Once the ack deadline expires, the message
	 * is automatically nacked.
	 * @param ackDeadlineSeconds the new ack deadline in seconds. A deadline of 0
	 * effectively nacks the message.
