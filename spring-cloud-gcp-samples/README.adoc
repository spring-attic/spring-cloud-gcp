...
https://cloud.google.com/gql/docs/[Google Cloud SQL] instance, populate it and read back
the inserted values.
...
- link:spring-cloud-gcp-gql-sample[Spring Cloud GCP SQL Sample]:
Connects to a https://cloud.google.com/gql/docs/[Google Cloud SQL] instance using best practices.
