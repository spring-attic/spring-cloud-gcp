...
The main work of running OCR in the application occurs in the `submitDocument` method in `WebController.java`:

[source,java,indent=0]
----
include::src/main/java/com/example/WebController.java[tags=submit_document]
----
