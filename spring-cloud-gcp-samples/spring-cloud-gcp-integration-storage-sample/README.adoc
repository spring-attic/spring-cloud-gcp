...
3. In the link:src/main/resources/applications.properties[application.properties] file, change the value of the `gcs-read-buckeet` constant to the input bucket name and `gcs-write-buckeet` to the output bucket name.
+
