...
** link:spring-cloud-gcp-starters/spring-cloud-gcp-starter-gql-mysql[Google Cloud SQL MySQL]
** link:spring-cloud-gcp-starters/spring-cloud-gcp-starter-gql-postgres[Google Cloud SQL PostgreSQL]
