...
https://docs.spring.io/spring-cloud-gcp/docs/1.0.0.M2/reference/htmlsingle/[Spring
...
* link:spring-cloud-gcp-pubsub/src/main/java/org.springframework.cloud.gcp.pubsub/integration[Spring Integration Channel Adapters for Google Cloud Pub/Sub]
...
* link:spring-cloud-gcp-storage/src/main/java/org.springframework.cloud.gcp.storage/integration[Spring Integration Channel Adapters for Google Cloud Storage]
* link:spring-cloud-gcp-data-spanner[Spring Data Spanner]
...
Spring Initializr contains Spring Cloud GCP autoconfguration support through the `GCP Support` entry.
