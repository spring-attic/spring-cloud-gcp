...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/2.0.1/reference/html/index.html[Spring Cloud GCP 2.0.1]
...
For example, the version `2.0.2-SNAPSHOT` is available from this repository.
