...
import org.springframework.cloud.gcp.data.spanner.core.admin.CachingDatabaseClientProvider;
...
public class SpannerTemplateTests {
	...
	public void multipleDatabaseClientTest() {
		...
		Supplier<DatabaseClient> clientProvider = new CachingDatabaseClientProvider<>(regionProvider,
