...
public class RequiredFieldsJwtClaimsSetVerifierTest {
	...
	RequiredFieldsJwtClaimsSetVerifier verifier = new RequiredFieldsJwtClaimsSetVerifier();

	@Test
	public void allRequiredFieldsPresentSucceeds() throws BadJWTException {
		this.verifier.verify(this.claimsSet, null);
	}
}
