...
| `spring.cloud.gcp.firestore.host-port` | The host and port of the Firestore service; can be overridden to specify connecting to an emulator instance. | No | `firestore.googleapis.com:443` (the host/port of official Firestore service)
