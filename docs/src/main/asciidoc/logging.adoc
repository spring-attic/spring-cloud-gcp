...
==== Log via API
A Stackdriver appender is available using `com/google/cloud/spring/logging/logback-appender.xml`.
...
A https://github.com/GoogleCloudPlatform/spring-cloud-gcp/tree/master/spring-cloud-gcp-samples/spring-cloud-gcp-logging-sample[Sample Spring Boot Application] is provided to show how to use the Cloud logging starter.
