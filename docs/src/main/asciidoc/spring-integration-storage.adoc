...
See the https://github.com/spring-cloud/spring-cloud-gcp/tree/main/spring-cloud-gcp-samples/spring-cloud-gcp-integration-storage-sample[Spring Integration with Google Cloud Storage Sample Code].
