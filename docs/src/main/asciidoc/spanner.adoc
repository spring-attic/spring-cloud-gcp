...
In case your Query or Read returns fewer columns than the entity that it is mapped to, Spring Data will map the returned columns and leave the rest as they of the columns are.
