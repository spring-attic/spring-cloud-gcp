...
This will allow you to omit specify versions for any of the Maven dependencies and instead delegate versioning to the BOM.
...
They are named like `1.1.0.M1` or `1.1.0.M2` and are released more frequently than GA `RELEASE` versions.
...
For example, the `1.2.0.BUILD-SNAPSHOT` is available from this repository.
