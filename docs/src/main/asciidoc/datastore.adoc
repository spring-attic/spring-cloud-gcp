...
They are stored in their entirety in the `children` field of the `parents` kind.
...
We can store a trees in Cloud Datastore using this feature:
...
A https://github.com/spring-cloud/spring-cloud-gcp/tree/master/spring-cloud-gcp-samples/spring-cloud-gcp-data-datastore-sample[Sample Spring Boot Application] is provided to show how to use the Spring Data Cloud Datastore starter and template.