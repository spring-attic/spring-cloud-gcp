...
The Spring Boot GCP starter auto-configures a `GcpProjectIdProvider`.
...
The Spring Boot GCP starter auto-configures a `CredentialsProvider`.
...
The Spring Boot GCP starter allows you to configure a custom scope list for the provided
credentials.
