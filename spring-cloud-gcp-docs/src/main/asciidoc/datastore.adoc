...
The `@Embedded` annotation on the map properties indicate that the entire property will be stored as an embedded entity.
The `@EmbeddedComponent` annotation indicates that the individual items inside the list and map properties will be stored as embedded entities.
