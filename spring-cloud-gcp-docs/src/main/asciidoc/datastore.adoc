...
After writing a custom repository interface specifying just the signatures of these methods, you can
implementations are generated for you and can be used with an auto-wired instance of the repository.
