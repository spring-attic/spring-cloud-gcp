...
The names of the initialTags of the GQL correspond to the `@Param` annotated names of the method parameters.
...
You can also specify queries with Cloud Datastore parameter initialTags and SpEL expressions in properties files.
