...
of the starter is to read configuration from properties and assume default settings so that user
experience connecting to MySQL is as easy as possible.
...
your own `CloudSqlJdbcInfoProvider` bean, in which case you should also register the
