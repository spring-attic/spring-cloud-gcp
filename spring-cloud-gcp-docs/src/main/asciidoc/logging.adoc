...
A https://github.com/spring-cloud/spring-cloud-gcp/tree/{git_version}/spring-cloud-gcp-samples/spring-cloud-gcp-logging-sample[sample application] is available.
...
The behavior of the trace ID extraction can be configured with the `spring.cloud.gcp.logging.traceIdExtractor` property:
