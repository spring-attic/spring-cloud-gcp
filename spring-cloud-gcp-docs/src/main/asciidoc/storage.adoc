...
spring.cloud.gcp.storage.credentials.scope=[COMMA_DELIMITED_SCOPE_LIST] #optional
----
...
`spring.cloud.gcp.storage.credentials.location` and `spring.cloud.gcp.storage.credentials.scope`
