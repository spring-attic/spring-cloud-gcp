...
public class Trader {
	...
	public Trader(String singerId, String firstName) {
...
public interface TradeRepository extends CrudRepository<Trade, String[]> {
	...
	List<Trade> findTop3DistinctByActionAndSymbolIgnoreCaseOrTraderIdOrderBySymbolDesc(
  			String action, String symbol, String singerId);
}
----
...
The function `List<Trade> findTop3DistinctByActionAndSymbolIgnoreCaseOrTraderIdOrderBySymbolDesc(String action, String symbol, String singerId);` will be translated as the equivalent of this SQL query:
...
public interface TradeRepository extends SpannerRepository<Trade, Key> {
	...
	List<Trade> findByTraderId(String singerId);
