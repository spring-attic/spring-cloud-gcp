...
Simple constructors are supported on POJOs. The constructor arguments can be a subset of the persistent properties or all of them. Constructor arguments that do not map to a persistent property are not supported.
