...
`spring-integration-file` dependency, since they aren't pulled transitively.
...
A https://github.com/spring-cloud/spring-cloud-gcp/tree/{git_version}/spring-cloud-gcp-samples/spring-cloud-gcp-integration-storage-sample[sample application] is available.
