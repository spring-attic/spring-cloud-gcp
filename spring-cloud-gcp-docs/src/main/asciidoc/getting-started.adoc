...
https://github.com/spring-cloud/spring-cloud-gcp/tree/{git_version}/spring-cloud-gcp-samples/spring-cloud-gcp-vision-api-sample[This one] shows how to use `spring-cloud-gcp-starter` for authentication.
