...
== Configuration
The following properties are available with `spring.cloud.gcp.security.iap` prefix (this may be useful for testing, but the defaults should not be changed in production):
