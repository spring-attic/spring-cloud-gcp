...
public class CloudVisionTemplate {
	 ...
	 * @throws {@link CloudVisionTemplate} if the image could not be read or if text extraction failed
	 */
	 ...
	 * @throws {@link CloudVisionTemplate} if the image could not be read or if a malformed response
